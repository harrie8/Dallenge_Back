...
[[Challenge-질문으로-챌린지들-조회하기]]
=== 질문으로 챌린지들 찾기

operation::challenge-controller-doc-test/search-challenges-by-question-test[snippets='http-request,request-fields']
