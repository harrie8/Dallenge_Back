...
operation::challenge-controller-doc-test/search-challenges-by-hashtag-test[snippets='http-request,request-parameters']

.HTTP Response
[%collapsible]
=====
include::{snippets}/challenge-controller-doc-test/search-challenges-by-hashtag-test/http-response.adoc[]
include::{snippets}/challenge-controller-doc-test/search-challenges-by-hashtag-test/response-fields.adoc[]
=====
